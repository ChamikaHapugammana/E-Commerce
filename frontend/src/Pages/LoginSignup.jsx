    ...
    <div className='loginsignup'>
      <div className="loginsignup-container">
        ...
        {state === 'Sign Up'? <p className='loginsignup-login'>
          Already have an account <span  className = 'login-span' onClick={()=>{setState('Login')}}>Login here</span> 
        </p> : <p className='loginsignup-login'>
          Create an Account <span className = 'login-span' onClick={()=>{setState('Sign Up')}} >Click Here</span> 
        </p> }
